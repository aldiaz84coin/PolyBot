 ...
 *
 * v1.2 — Añadidas claves arb_enabled, arb_simulate_mode, arb_stake_usdc
 *         al whitelist para que ArbModeSelector las pueda leer/escribir.
 *
 * GET  /api/config?key=xxx   → { key, value, updated_at }
...
export async function POST(req) {
  ...
  try {
    ...
    // Si es un cambio de modo principal, registrar también quién lo cambió
    if (key === "trading_mode") {
