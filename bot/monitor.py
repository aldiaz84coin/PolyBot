"""
monitor.py — v10.2  (importaciones absolutas — bot/ root)
Ver bot/modules/monitor.py para documentación completa.

# ───────────────────────────────────────────────────────────────
# Contenido idéntico a bot/modules/monitor.py salvo las rutas de
# importación (absolutas en lugar de relativas).
# ───────────────────────────────────────────────────────────────
...
import db   # módulo de persistencia Supabase
