"""
monitor.py (importaciones absolutas — bot/ root)
...
import db  # módulo de persistencia Supabase (v9.0)
...
def _sync_session_to_db(now, market_slug, hour_wins, hour_losses, hour_stops,
